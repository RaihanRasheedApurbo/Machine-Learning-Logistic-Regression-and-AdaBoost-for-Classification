...
class Logistic_Regression:
    ...
    def __init__(self, x_values, y_values, alpha=0.00005, max_iterations=100) -> None:
        ...
        y_values = y_values.replace(to_replace=0, value=-1)
    ...
    def predict(self, x):
        ...
        churn = churn.replace(to_replace=False, value=0)
        return churn
...
logger.warning(churn.value_counts())
result = (y == churn).mean()
